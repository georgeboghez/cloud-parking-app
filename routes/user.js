...
router.post(
    ...
    [
        ...
        .not()
        .isEmpty(),
        check("businessname", "Please Enter a Business Name")
        .not()
        .isEmpty(),
        check("businesstype", "Please Enter a Business Type")
        .not()
        .isEmpty(),
        check("email", "Please enter a valid email").isEmail(),
        check("password", "Please enter a valid password").isLength({
    ...
    async (req, res) => {
        ...
        try {
            let query = datastore.createQuery('User').filter("email", "=", email);
            const [users] = await datastore.runQuery(query);
            ...
            query = datastore.createQuery('User').filter("businessname", "=", businessname);
            const [businessnames] = await datastore.runQuery(query);
